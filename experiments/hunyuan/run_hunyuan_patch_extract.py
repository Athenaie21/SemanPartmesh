...
ROOT = SCRIPT_DIR.parents[1]  # repo root
OUT_ROOT = SCRIPT_DIR / 'final_extract'
...
for name in MESHES:
    mesh_path = SCRIPT_DIR / 'pipeline_output_hunyuan_repaired' / 'processed_meshes' / f'{name}.obj'
    cf_path = SCRIPT_DIR / 'pipeline_output_hunyuan_repaired' / 'neurcross_logs' / name / 'save_crossField' / f'{name}_iter_9999.txt'
