...
#  Usage:
#    tmux new -s recon
#    bash run_reconstruction_batch.sh
# ==========================================================================

DATASET_ROOT="/root/shared-nvme/SemanPartMesh/instruction_guidance/r1.0.1/reconstruction"
OUTPUT_ROOT="/root/SemanPartMesh/reconstruction_batch_output"
GPU_ID="0"
...
PYTHON_NC="/root/.conda/envs/neurcross/bin/python"
PIPELINE="/root/SemanPartMesh/run_pipeline.py"
...
score_quad_quality() {
    local quad_path="$1"
    local mesh_path="$2"
    "${PYTHON_NC}" - "${quad_path}" "${mesh_path}" <<'PYEOF'
import json
import math
import sys
