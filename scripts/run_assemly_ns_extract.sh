...
INPUT_DIR="${2:-${ROOT_DIR}/data/assemly}"
OUTPUT_DIR="${3:-${ROOT_DIR}/experiments/assemly/output_${METHOD}}"
GPU_ID="${4:-0}"

PYTHON_BIN="${PYTHON_BIN:-python}"
PIPELINE_SCRIPT="${ROOT_DIR}/run_pipeline.py"
BASELINE_SCRIPT="${ROOT_DIR}/scripts/run_baseline_simplified.sh"
ITER_EXTRACT_SCRIPT="${ROOT_DIR}/scripts/run_extract_existing_iters.sh"
